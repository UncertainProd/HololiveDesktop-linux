...
Double Click the HololiveEN Myth Shimeji-ee file (HololiveEN Myth Shimeji-ee.jar).
...
3. Start HololiveEN Myth Shimeji-ee.  Now Shimeji and Batman will drop.  Right click Batman to perform Batman specific options.  Adding "Call Shimeji" from the tray icon will randomly create add either Shimeji or Batman.

When HololiveEN Myth Shimeji-ee starts, one Shimeji for every image set in the img folder will be created.  If you have too many image sets, a lot of your computer's memory will be used... so be careful.  HololiveEN Myth Shimeji-ee can eat up to 60% of your system's free memory.  

HololiveEN Myth Shimeji-ee will ignore all the image sets that are in the img/unused folder, so you can hide image sets in there.  There is also a tool, Image Set Chooser, that will let you select image sets at run time.  It remembers previous options via the conf/settings.properties file.  Don't choose too many at once.
...
HololiveEN Myth Shimeji-ee will ignore all the image sets that are in the img/unused folder, so you can hide image sets in there.  There is also a tool, Image Set Chooser, that will let you select image sets at run time.  It remembers previous options via the ActiveShimeji file.  Don't choose too many at once.
...
Programmers may feel free to use the source.  The HololiveEN Myth Shimeji-ee source is under the New BSD license.
...
HololiveEN Myth Shimeji-ee takes a LOT of time to start if you have a lot of image sets, so give it some time.  Try moving all but one image set from the img folder to the img/unused folder to see if you have a memory problem.  If Shimeji is running out of memory, try editing HololiveEN Myth Shimeji-ee.bat and change "-Xmx1000m" to a higher number.

If the HololiveEN Myth Shimeji-ee icon appears, but no Shimeji appear:

1. Make sure you have the newest version of HololiveEN Myth Shimeji-ee.
2. Make sure you only have image set folders in your img directory.
3. Make sure you have Java on your system.
4. If you're somewhat computer savvy, you can try running HololiveEN Myth Shimeji-ee from the command line.  Navigate to the HololiveEN Myth Shimeji-ee directory and run this command: "C:\Program Files (x86)\Java\jre6\bin\java" -jar HololiveEN Myth Shimeji-ee.jar
5. Try checking the log (ShimejiLogX.log) for errors.  If you find a bug (which is very likely), post it up on the HololiveEN Myth Shimeji-ee homepage in the issues section.