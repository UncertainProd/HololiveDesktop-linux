 ...
 */
public class Breeder extends Animate {
    private static final Logger log = Logger.getLogger(Breeder.class.getName());
    ...
    public Breeder(java.util.ResourceBundle schema, final List<Animation> animations, final VariableMap context) {
