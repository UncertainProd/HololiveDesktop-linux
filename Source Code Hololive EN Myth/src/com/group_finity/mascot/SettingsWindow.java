...
public class SettingsWindow extends javax.swing.JDialog
{
    ...
    public void init( )
    {
        ...
        runOnStartup = Boolean.parseBoolean( properties.getProperty( "RunOnStartup", "false" ) );
        ...
        chkRunOnStartup.setSelected( runOnStartup );
    ...
    private void initComponents()
    {
        ...
        sldOpacity = new javax.swing.JSlider();
        lblOpacity = new javax.swing.JLabel();
        chkRunOnStartup = new javax.swing.JCheckBox();
        ...
        chkRunOnStartup.setText("Run On Startup");
        chkRunOnStartup.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chkRunOnStartupItemStateChanged(evt);
            }
        });
        ...
        lblShimejiEE.setText("Hololive Myth (FirstGen)");
        ...
        lblDevelopedBy.setText("Customized and created by");
        lblDevelopedBy.setAlignmentX(0.5F);
        pnlAbout.add(lblDevelopedBy);

        lblKilkakon.setText("Niseno Shitsu");
        ...
        btnWebsite.setText("Dev's Website");
        btnWebsite.setAlignmentX(0.5F);
        btnWebsite.setMaximumSize(new java.awt.Dimension(130, 26));
        btnWebsite.setPreferredSize(new java.awt.Dimension(120, 26));
        ...
        btnDiscord.setText("Niseno's YouTube");
        btnDiscord.setAlignmentX(0.5F);
        btnDiscord.setMaximumSize(new java.awt.Dimension(130, 26));
        btnDiscord.setPreferredSize(new java.awt.Dimension(120, 26));
        ...
        btnPatreon.setText("Niseno's Patreon");
        btnPatreon.setAlignmentX(0.5F);
        btnPatreon.setMaximumSize(new java.awt.Dimension(130, 26));
        btnPatreon.setPreferredSize(new java.awt.Dimension(120, 26));
    ...
    {//GEN-HEADEREND:event_btnDoneActionPerformed
        ...
        try
        {
            ...
            try
            {
                ...
                properties.setProperty( "RunOnStartup", runOnStartup.toString( ) );
    ...
    private void chkRunOnStartupItemStateChanged(java.awt.event.ItemEvent evt) {
        runOnStartup = evt.getStateChange() == ItemEvent.SELECTED;
        if (runOnStartup) {
            executeBatchFile("add_to_startup.bat");
        } else {
            executeBatchFile("remove_from_startup.bat");
        }
    }
    
    private void executeBatchFile(String batchFileName) {
        try {
            ProcessBuilder pb = new ProcessBuilder("cmd", "/c", batchFileName);
            pb.directory(new File(System.getProperty("user.dir"))); // Set working directory to current directory
    ...
    {//GEN-HEADEREND:event_btnDiscordActionPerformed
        browseToUrl( "https://www.youtube.com/@nisenoshitsu" );
    ...
    {//GEN-HEADEREND:event_btnPatreonActionPerformed
        browseToUrl( "https://patreon.com/nisenoshitsu" );
    ...
    private javax.swing.JCheckBox chkRunOnStartup;
